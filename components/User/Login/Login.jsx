                ...
                >
                  <div className="relative flex items-center space-x-4 justify-center">
                    <img
                      ...
                      alt="google logo"
                    />
                    <span className="pl-1 block w-max font-semibold tracking-wide text-gray-700 text-sm transition duration-300 group-hover:text-slate-700 sm:text-base">
                      Continue with Google
                    </span>
                  </div>
                </button>
                <button onClick={handleGithubLogin}
                  className="mt-5 sm:mt-0	 md:mt-0	 lg:mt-0	2xl:mt-0 xl:mt-0	  group h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300 
                                  hover:border-slate-700 focus:bg-blue-50 active:bg-blue-100"
                >
                  <div className=" relative flex items-center space-x-4 justify-center">
                    <svg
