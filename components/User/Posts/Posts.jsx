...
import { likePostReq } from "../../../Api/userApi/postRequest";
      ...
      >
            ...
            <div className="flex items-center gap-2">
              ...
              <span>
                ...
                >
                  ...
                  3.745 0 01-1.043 3.296 3.745 3.745 0 01-3.296 1.043A3.745 3.745
                  0 0112 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 01-3.296-1.043 3.745
                   3.745 0 01-1.043-3.296A3.745 3.745 0 013 12c0-1.268.63-2.39
                      1.593-3.068a3.745 3.745
                    0 011.043-3.296 3.746 3.746 0 013.296-1.043A3.746 3.746 0 0112 3c1.268
                  0 2.39.63 3.068 1.593a3.746 3.746 0 013.296 1.043 3.746 3.746 0 011.043
              ...
              <div className="relative">
                {dropdownOpen && (
                  <div className="absolute right-6 border border-gray-300 bg-white shadow-md shadow-gray-100 p-3 rounded-md w-36">
                    <p
                      href=""
                      className="flex gap-3 py-2 my-2 hover:bg-[#bbc0c7] -mx-2 px-2 rounded-md transition-all hover:scale-110 hover:shadow-md shadow-gray-400"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
        ...
        <div className="flex mt-5 gap-4">
          ...
          >
            <img
              className="h-4"
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTztLI8R6jo_I1t7FG6Dk5WMyqBSSYbZTIukQ&usqp=CAU"
              alt=""
            />
            copy
          </button>
        ...
        <div className="mt-3">
          {commentsOpen && <Comments postId={post?._id} setCount={setCount} count={count} />}
        </div>
      </div>
    </>
  );
